...
function sunset_contact_email_callback($post){
  ...
  echo '<label for="sunset_contact_email_field">User Email Address</label>
        <input typr="email" id="sunset_contact_email_field" name="sunset_contact_email_field" value="' . esc_attr($value) . '" size="25" />';
}
...
function sunset_save_contact_email_data($post_id){
  ...
  $myData = sanitize_text_field($_POST['sunset_contact_email_field']);
